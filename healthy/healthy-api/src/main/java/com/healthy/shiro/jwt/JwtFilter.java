...
import com.uni.util.JsonConvertUtil;
   ...
   /* *//**
    ...
    private void response401(ServletResponse response, String msg) {
        ...
        try (PrintWriter out = httpServletResponse.getWriter()) {
            String data = JsonConvertUtil.objectToJson(Response.error(HttpStatus.UNAUTHORIZED.value()+"无权访问(Unauthorized):" + msg));
            out.append(data);
        } catch (IOException e) {
