...
import com.healthy.shiro.jwt.JwtFilter;
...
import com.healthy.shiro.cache.CustomCacheManager;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
        ...
        // 获取公钥 放行
        filterChainDefinitionMap.put("/sys/getPublicKey", "anon");
        // 获取验证码放行
        filterChainDefinitionMap.put("/common/createCaptcha", "anon");
